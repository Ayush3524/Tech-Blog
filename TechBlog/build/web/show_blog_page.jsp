        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="profile.jsp"> <span class="fa fa-bell-o"></span> LearnCode with Ayush <span class="sr-only">(current)</span></a>
                </li>
            ...
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <img class="card-img-top my-2" src="blog_pic/<%= p.getpPic()%>" alt="Error">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="profile-edit-btn" type="submit" class="btn btn-primary">Edit</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="AddPostServlet" method="post" id="add-post-form" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <textarea  class="form-control" name="pContent" placeholder="Enter Content Here" style="height: 200px"></textarea>
                            </div>
                            <div class="form-group">
        ...
        <script>
            $(document).ready(function (e) {
                ...
                $('#add-post-form').on("submit", function (event) {
                    //                      this function get called when form submitted
